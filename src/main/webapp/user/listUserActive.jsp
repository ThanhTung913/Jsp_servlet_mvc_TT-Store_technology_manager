    ...
    <div class="navbar-custom">
        ...
        <ul class="list-unstyled topnav-menu topnav-menu-left m-0">
            ...
            <li class="d-none d-lg-block">
                <form class="app-search" method="post" action="/users?action=searchUserActive">
                    <div class="app-search-box">
                        <div class="input-group">
                            <input type="text" class="form-control" placeholder="Search..." name="searchUserActive"
                                   onchange="buttonsearch" value="${searchUserActive}">
            ...
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title mb-4"
                        style="font-size: 20px; font-family: American Typewriter; text-align: center">LIST USER
                        ACTIVE</h4>
                    <div class="table-responsive">
                        <table class="table table-centered" id="btn-editable">
                            ...
                            <tbody>
                            <tr id="2">
                                <c:forEach var="user" items="${listUserActive}">
