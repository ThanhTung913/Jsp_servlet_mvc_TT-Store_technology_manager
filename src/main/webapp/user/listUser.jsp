    ...
    <div class="navbar-custom">
        ...
        <ul class="list-unstyled topnav-menu topnav-menu-left m-0">
            ...
            <li class="d-none d-lg-block">
                <form class="app-search" method="post" action="/users?action=search">
                    <div class="app-search-box">
                        <div class="input-group">
                            <input type="text" class="form-control" placeholder="Search..." name="searchUser"
                                   onchange="buttonsearch" value="${searchUser}">
            ...
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title mb-4"
                        style="font-size: 20px; font-family: American Typewriter; text-align: center">LIST USER</h4>
